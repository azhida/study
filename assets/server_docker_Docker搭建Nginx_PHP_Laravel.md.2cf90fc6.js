...
<span class="line"><span style="color:#babed8;"></span></span></code></pre></div><ul><li>访问 <a href="http://ip:8081" target="_blank" rel="noreferrer">http://ip:8081</a> ，就可以看到 laravel 首页了</li></ul><blockquote><p>注意：ip 对应的 8081 端口需要开放外部访问权限，否则访问失败<br> 至于 页面报错，就是 laravel 相关的配置了，具体去看 laravel 的文档</p></blockquote><h2 id="配置-nginx-反向代理支持-域名访问" tabindex="-1">配置 nginx 反向代理支持 域名访问 <a class="header-anchor" href="#配置-nginx-反向代理支持-域名访问" aria-label="Permalink to &quot;配置 nginx 反向代理支持 域名访问&quot;">​</a></h2><p>看这里： <a href="./Docker搭建Nginx反向代理服务器.html">Docker搭建Nginx反向代理服务器</a></p><h2 id="容器内的-laravel-项目访问宿主机-3306-端口" tabindex="-1">容器内的 laravel 项目访问宿主机 3306 端口 <a class="header-anchor" href="#容器内的-laravel-项目访问宿主机-3306-端口" aria-label="Permalink to &quot;容器内的 laravel 项目访问宿主机 3306 端口&quot;">​</a></h2><ul><li><code>.env</code></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#babed8;">DB_CONNECTION=mysql</span></span>
<span class="line"><span style="color:#babed8;">DB_HOST=host.docker.internal</span></span>
<span class="line"><span style="color:#babed8;">DB_PORT=3306</span></span>
<span class="line"><span style="color:#babed8;">DB_DATABASE=test</span></span>
<span class="line"><span style="color:#babed8;">DB_USERNAME=test</span></span>
<span class="line"><span style="color:#babed8;">DB_PASSWORD=test</span></span>
<span class="line"><span style="color:#babed8;"></span></span></code></pre></div>`,28),o=[p];function c(r,t,i,d,b,h){return s(),n("div",null,o)}const v=a(e,[["render",c]]);export{g as __pageData,v as default};
