import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.aaef0e9b.js";const h=JSON.parse('{"title":"NodeJS 使用笔记","description":"","frontmatter":{},"headers":[],"relativePath":"web/js/nodejs/nodejs使用笔记.md","lastUpdated":1702265459000}'),l={name:"web/js/nodejs/nodejs使用笔记.md"},p=e(`<h1 id="nodejs-使用笔记" tabindex="-1">NodeJS 使用笔记 <a class="header-anchor" href="#nodejs-使用笔记" aria-label="Permalink to &quot;NodeJS 使用笔记&quot;">​</a></h1><h2 id="安装nodejs-—-linux" tabindex="-1">安装nodejs — linux <a class="header-anchor" href="#安装nodejs-—-linux" aria-label="Permalink to &quot;安装nodejs — linux&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#babed8;">wget https://nodejs.org/dist/v14.19.2/node-v14.19.2-linux-x64.tar.xz</span></span>
...
<span class="line"><span style="color:#babed8;"></span></span></code></pre></div><h2 id="npm-安装-yarn" tabindex="-1">npm 安装 yarn <a class="header-anchor" href="#npm-安装-yarn" aria-label="Permalink to &quot;npm 安装 yarn&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#babed8;"># windows 通过 npm安装yarn</span></span>
...
<span class="line"><span style="color:#babed8;"></span></span></code></pre></div><h2 id="修改全局依赖包下载路径" tabindex="-1">修改全局依赖包下载路径 <a class="header-anchor" href="#修改全局依赖包下载路径" aria-label="Permalink to &quot;修改全局依赖包下载路径&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#babed8;"># 默认情况下，我们在执行npm install -g XXXX下载全局包时，这个包的默认存放路径位C:\\Users\\用户名\\AppData\\Roaming\\npm\\node_modules 下，可以通过CMD指令npm root -g查看</span></span>
...
<span class="line"><span style="color:#babed8;"></span></span></code></pre></div><h2 id="npm-镜像" tabindex="-1">npm 镜像 <a class="header-anchor" href="#npm-镜像" aria-label="Permalink to &quot;npm 镜像&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#babed8;"># npm 查询当前配置的镜像</span></span>
...
<span class="line"><span style="color:#babed8;"></span></span></code></pre></div><h2 id="scss-版本的对应关系" tabindex="-1">Scss--版本的对应关系 <a class="header-anchor" href="#scss-版本的对应关系" aria-label="Permalink to &quot;Scss--版本的对应关系&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#babed8;"># Scss--版本的对应关系(sass, sass-loader, dart-sass, node-sass等）</span></span>
...
<span class="line"><span style="color:#babed8;"></span></span></code></pre></div>`,13),o=[p];function t(c,i,r,d,b,y){return a(),n("div",null,o)}const g=s(l,[["render",t]]);export{h as __pageData,g as default};
