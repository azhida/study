import{_ as s,c as a,o as n,a5 as e}from"./chunks/framework.CJNr4pYi.js";const m=JSON.parse('{"title":"laravel9 自定义 request 验证的返回格式","description":"","frontmatter":{},"headers":[],"relativePath":"php/laravel/laravel9自定义resquest验证的返回格式.md","filePath":"php/laravel/laravel9自定义resquest验证的返回格式.md","lastUpdated":1722327281000}'),p={name:"php/laravel/laravel9自定义resquest验证的返回格式.md"},l=e(`<h1 id="laravel9-自定义-request-验证的返回格式" tabindex="-1">laravel9 自定义 request 验证的返回格式 <a class="header-anchor" href="#laravel9-自定义-request-验证的返回格式" aria-label="Permalink to &quot;laravel9 自定义 request 验证的返回格式&quot;">​</a></h1><p>新建 request 基类文件<br> app/Http/Requests/Api/FormRequest.php</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;?php</span></span>
