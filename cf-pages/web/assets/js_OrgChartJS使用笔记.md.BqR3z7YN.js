import{_ as s,c as a,o as n,a5 as p}from"./chunks/framework.DT3Bu3jt.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"js/OrgChartJS使用笔记.md","filePath":"js/OrgChartJS使用笔记.md","lastUpdated":1722500431000}'),e={name:"js/OrgChartJS使用笔记.md"},t=p(`<p><a href="https://balkan.app/OrgChartJS" target="_blank" rel="noreferrer">官网</a></p><h6 id="配置项详解" tabindex="-1">配置项详解 <a class="header-anchor" href="#配置项详解" aria-label="Permalink to &quot;配置项详解&quot;">​</a></h6><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>var config = {</span></span>
