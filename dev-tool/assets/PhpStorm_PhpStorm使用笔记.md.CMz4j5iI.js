import{_ as a,c as s,o as n,a5 as e}from"./chunks/framework.DPGmCwCP.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"PhpStorm/PhpStorm使用笔记.md","filePath":"PhpStorm/PhpStorm使用笔记.md","lastUpdated":null}'),p={name:"PhpStorm/PhpStorm使用笔记.md"},t=e(`<h6 id="调整字体大小" tabindex="-1">调整字体大小 <a class="header-anchor" href="#调整字体大小" aria-label="Permalink to &quot;调整字体大小&quot;">​</a></h6><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># File --&gt; Settings --&gt; Keymap --&gt; Editor Actions</span></span>
...
<span class="line"><span>-&gt;OK</span></span></code></pre></div>`,10),i=[t];function l(o,c,r,h,d,u){return n(),s("div",null,i)}const b=a(p,[["render",l]]);export{g as __pageData,b as default};
