import{_ as s,c as n,o as e,a3 as p}from"./chunks/framework.D_jhnXES.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"PhpStorm/PhpStorm使用笔记.md","filePath":"PhpStorm/PhpStorm使用笔记.md","lastUpdated":1722566592000}'),t={name:"PhpStorm/PhpStorm使用笔记.md"};function i(l,a,o,c,r,d){return e(),n("div",null,a[0]||(a[0]=[p(`<h6 id="调整字体大小" tabindex="-1">调整字体大小 <a class="header-anchor" href="#调整字体大小" aria-label="Permalink to &quot;调整字体大小&quot;">​</a></h6><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># File --&gt; Settings --&gt; Keymap --&gt; Editor Actions</span></span>
...
<span class="line"><span>-&gt;OK</span></span></code></pre></div>`,10)]))}const u=s(t,[["render",i]]);export{m as __pageData,u as default};
