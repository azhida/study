import{_ as s,o as a,c as n,Q as t}from"./chunks/framework.92222dd1.js";const d=JSON.parse('{"title":"vue 文件保存时自动格式化","description":"","frontmatter":{},"headers":[],"relativePath":"dev-tool/VSCode/vue文件保存时自动格式化.md","lastUpdated":1680516788000}'),o={name:"dev-tool/VSCode/vue文件保存时自动格式化.md"},e=t(`<h1 id="vue-文件保存时自动格式化" tabindex="-1">vue 文件保存时自动格式化 <a class="header-anchor" href="#vue-文件保存时自动格式化" aria-label="Permalink to &quot;vue 文件保存时自动格式化&quot;">​</a></h1><h2 id="安装插件" tabindex="-1">安装插件 <a class="header-anchor" href="#安装插件" aria-label="Permalink to &quot;安装插件&quot;">​</a></h2><ul><li>eslint</li><li>Vetur</li><li>Prettier - Code formatter</li></ul><h2 id="修改编辑器配置文件" tabindex="-1">修改编辑器配置文件 <a class="header-anchor" href="#修改编辑器配置文件" aria-label="Permalink to &quot;修改编辑器配置文件&quot;">​</a></h2><ul><li>打开编辑器配置文件：文件--首选项--设置--打开设置文件(json)【设置页面的右上角】</li><li>写入内容（注意：是添加，不要删除你原来的配置，如果有重复就单独处理即可）</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">{</span></span>
