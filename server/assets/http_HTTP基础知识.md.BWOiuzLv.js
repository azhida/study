import{_ as a,c as n,o as s,a3 as p}from"./chunks/framework.CFZOmcOm.js";const u=JSON.parse('{"title":"HTTP 基础知识","description":"","frontmatter":{},"headers":[],"relativePath":"http/HTTP基础知识.md","filePath":"http/HTTP基础知识.md","lastUpdated":1722327281000}'),e={name:"http/HTTP基础知识.md"},t=p(`<h1 id="http-基础知识" tabindex="-1">HTTP 基础知识 <a class="header-anchor" href="#http-基础知识" aria-label="Permalink to &quot;HTTP 基础知识&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># HTTP 提交数据有两种方式：</span></span>
