import{_ as s,c as a,o as n,a3 as p}from"./chunks/framework.CFZOmcOm.js";const f=JSON.parse('{"title":"使用笔记","description":"","frontmatter":{},"headers":[],"relativePath":"linux/ubuntu/使用笔记.md","filePath":"linux/ubuntu/使用笔记.md","lastUpdated":1722327281000}'),e={name:"linux/ubuntu/使用笔记.md"},l=p(`<h1 id="使用笔记" tabindex="-1">使用笔记 <a class="header-anchor" href="#使用笔记" aria-label="Permalink to &quot;使用笔记&quot;">​</a></h1><h2 id="查看ubuntu版本" tabindex="-1">查看Ubuntu版本: <a class="header-anchor" href="#查看ubuntu版本" aria-label="Permalink to &quot;查看Ubuntu版本:&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>sudo lsb_release -a</span></span></code></pre></div><h2 id="时区" tabindex="-1">时区 <a class="header-anchor" href="#时区" aria-label="Permalink to &quot;时区&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 修改时区</span></span>
