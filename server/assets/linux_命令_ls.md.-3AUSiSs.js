import{_ as a,c as s,o as n,a3 as e}from"./chunks/framework.CFZOmcOm.js";const q=JSON.parse('{"title":"ls 命令","description":"","frontmatter":{},"headers":[],"relativePath":"linux/命令/ls.md","filePath":"linux/命令/ls.md","lastUpdated":1722327281000}'),l={name:"linux/命令/ls.md"},p=e(`<h1 id="ls-命令" tabindex="-1">ls 命令 <a class="header-anchor" href="#ls-命令" aria-label="Permalink to &quot;ls 命令&quot;">​</a></h1><h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 查看当前目录下的文件数量（不包含子目录中的文件）</span></span>
