import{_ as a,c as s,o as n,a5 as p}from"./chunks/framework.CJNr4pYi.js";const g=JSON.parse('{"title":"Linux定时任务","description":"","frontmatter":{},"headers":[],"relativePath":"linux/定时任务使用笔记.md","filePath":"linux/定时任务使用笔记.md","lastUpdated":1722327281000}'),e={name:"linux/定时任务使用笔记.md"},l=p(`<h1 id="linux定时任务" tabindex="-1">Linux定时任务 <a class="header-anchor" href="#linux定时任务" aria-label="Permalink to &quot;Linux定时任务&quot;">​</a></h1><h6 id="方法一-编辑-etc-crontab文件-添加执行命令" tabindex="-1">方法一：编辑 /etc/crontab文件，添加执行命令 <a class="header-anchor" href="#方法一-编辑-etc-crontab文件-添加执行命令" aria-label="Permalink to &quot;方法一：编辑 /etc/crontab文件，添加执行命令&quot;">​</a></h6><p>vim /etc/crontab</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>* * * * * &#39;/usr/lib/php /var/www/laravel/artisan schedule:run &gt;&gt; /var/www/laravel/storage/logs/cron.log 2&gt;&amp;1&#39;</span></span></code></pre></div><h6 id="方法二-执行-crontab-e-命令" tabindex="-1">方法二：执行 crontab -e 命令 <a class="header-anchor" href="#方法二-执行-crontab-e-命令" aria-label="Permalink to &quot;方法二：执行 crontab -e 命令&quot;">​</a></h6><p>crontab -e</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>* * * * * &#39;/usr/lib/php /var/www/laravel/artisan schedule:run &gt;&gt; /var/www/laravel/storage/logs/cron.log 2&gt;&amp;1&#39;</span></span></code></pre></div><h5 id="两种方法的区别" tabindex="-1">两种方法的区别： <a class="header-anchor" href="#两种方法的区别" aria-label="Permalink to &quot;两种方法的区别：&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># vim /etc/crontab：系统级任务，多用户均可访问执行；</span></span>
