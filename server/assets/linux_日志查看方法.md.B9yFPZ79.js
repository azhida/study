import{_ as s,c as a,o as n,a5 as p}from"./chunks/framework.CJNr4pYi.js";const b=JSON.parse('{"title":"tail","description":"","frontmatter":{},"headers":[],"relativePath":"linux/日志查看方法.md","filePath":"linux/日志查看方法.md","lastUpdated":1722327281000}'),l={name:"linux/日志查看方法.md"},e=p(`<h1 id="tail" tabindex="-1">tail <a class="header-anchor" href="#tail" aria-label="Permalink to &quot;tail&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>命令格式: tail[必要参数][选择参数][文件]</span></span>
