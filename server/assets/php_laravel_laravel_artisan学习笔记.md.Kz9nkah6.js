import{_ as a,c as s,o as n,a5 as p}from"./chunks/framework.CJNr4pYi.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"php/laravel/laravel_artisan学习笔记.md","filePath":"php/laravel/laravel_artisan学习笔记.md","lastUpdated":1722327281000}'),e={name:"php/laravel/laravel_artisan学习笔记.md"},t=p(`<h6 id="维护模式" tabindex="-1">维护模式 <a class="header-anchor" href="#维护模式" aria-label="Permalink to &quot;维护模式&quot;">​</a></h6><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 1.开启维护模式：  </span></span>
