import{_ as s,c as a,o as n,a5 as p}from"./chunks/framework.CJNr4pYi.js";const g=JSON.parse('{"title":"viacreative/sudo-su","description":"","frontmatter":{},"headers":[],"relativePath":"php/php扩展包/viacreative.sudo-su.md","filePath":"php/php扩展包/viacreative.sudo-su.md","lastUpdated":1722327281000}'),e={name:"php/php扩展包/viacreative.sudo-su.md"},i=p(`<h1 id="viacreative-sudo-su" tabindex="-1">viacreative/sudo-su <a class="header-anchor" href="#viacreative-sudo-su" aria-label="Permalink to &quot;viacreative/sudo-su&quot;">​</a></h1><h2 id="composer地址" tabindex="-1">composer地址 <a class="header-anchor" href="#composer地址" aria-label="Permalink to &quot;composer地址&quot;">​</a></h2><p><a href="https://packagist.org/packages/viacreative/sudo-su" target="_blank" rel="noreferrer">https://packagist.org/packages/viacreative/sudo-su</a></p><h2 id="介绍" tabindex="-1">介绍 <a class="header-anchor" href="#介绍" aria-label="Permalink to &quot;介绍&quot;">​</a></h2><p>用户切换工具 sudo-su。当需要切换多个用户来测试，频繁地退出和登录用户是一个费时的事情，可以使用 sudo-su 用户切换工具，来提高效率。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><ul><li>使用 Composer 安装：</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>composer require &quot;viacreative/sudo-su:~1.1&quot;</span></span></code></pre></div><ul><li>添加 Provider</li></ul><p>我们只在开发环境中加载此扩展包：</p><p>app/Providers/AppServiceProvider.php</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;?php</span></span>
