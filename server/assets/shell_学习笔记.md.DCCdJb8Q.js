import{_ as a,c as s,o as n,a5 as p}from"./chunks/framework.CJNr4pYi.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"shell/学习笔记.md","filePath":"shell/学习笔记.md","lastUpdated":1722327281000}'),e={name:"shell/学习笔记.md"},l=p(`<h6 id="以当前日期时间命名创建一个文件夹" tabindex="-1">以当前日期时间命名创建一个文件夹 <a class="header-anchor" href="#以当前日期时间命名创建一个文件夹" aria-label="Permalink to &quot;以当前日期时间命名创建一个文件夹&quot;">​</a></h6><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>dirdate=\`date +%Y%m%d\`_\`date +%H%M%S\`</span></span>
