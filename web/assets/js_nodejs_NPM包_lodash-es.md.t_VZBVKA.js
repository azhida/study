import{_ as s,c as a,o as n,a3 as p}from"./chunks/framework.CDwh3-Fg.js";const k=JSON.parse('{"title":"lodash-es","description":"","frontmatter":{},"headers":[],"relativePath":"js/nodejs/NPM包/lodash-es.md","filePath":"js/nodejs/NPM包/lodash-es.md","lastUpdated":1722500431000}'),e={name:"js/nodejs/NPM包/lodash-es.md"},l=p(`<h1 id="lodash-es" tabindex="-1">lodash-es <a class="header-anchor" href="#lodash-es" aria-label="Permalink to &quot;lodash-es&quot;">​</a></h1><p><a href="https://www.lodashjs.com/" target="_blank" rel="noreferrer">官网</a></p><p>Lodash 是一个一致性、模块化、高性能的 JavaScript 实用工具库。</p><p>lodash-es模块使得我们能按需引入lodash对应的工具方法。</p><p>Lodash 通过降低 array、number、objects、string 等等的使用难度从而让 JavaScript 变得更简单。</p><p>Lodash 的模块化方法 非常适用于：</p><ul><li>遍历 array、object 和 string</li><li>对值进行操作和检测</li><li>创建符合功能的函数</li></ul><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm i --save lodash lodash-es</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2><blockquote><p>注意：如果下面碰到方法不能使用的情况，请检查安装lodash版本是否已经支持该版本了。</p></blockquote><h3 id="数组" tabindex="-1">数组 <a class="header-anchor" href="#数组" aria-label="Permalink to &quot;数组&quot;">​</a></h3><h4 id="concat-数组拼接" tabindex="-1">concat - 数组拼接 <a class="header-anchor" href="#concat-数组拼接" aria-label="Permalink to &quot;concat - 数组拼接&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 可对concat设置别名lodashConcat</span></span>
...
<span class="line"><span>    return false</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>})</span></span></code></pre></div><blockquote><p>说明：使用lodash库中的forEach方法则数组和对象均可遍历，并且使用显示返回false还能提前退出遍历。</p></blockquote>`,92),i=[l];function c(t,o,d,r,h,u){return n(),a("div",null,i)}const g=s(e,[["render",c]]);export{k as __pageData,g as default};
