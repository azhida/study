import{_ as n,c as s,o as a,a5 as p}from"./chunks/framework.DT3Bu3jt.js";const v=JSON.parse('{"title":"Node 多版本共存切换","description":"","frontmatter":{},"headers":[],"relativePath":"js/nodejs/Node多版本共存切换.md","filePath":"js/nodejs/Node多版本共存切换.md","lastUpdated":1722500431000}'),e={name:"js/nodejs/Node多版本共存切换.md"},l=p(`<h1 id="node-多版本共存切换" tabindex="-1">Node 多版本共存切换 <a class="header-anchor" href="#node-多版本共存切换" aria-label="Permalink to &quot;Node 多版本共存切换&quot;">​</a></h1><h2 id="卸载已经安装的-nodejs" tabindex="-1">卸载已经安装的 NodeJS <a class="header-anchor" href="#卸载已经安装的-nodejs" aria-label="Permalink to &quot;卸载已经安装的 NodeJS&quot;">​</a></h2><blockquote><p>一定要卸载干净，否则很大概率使用不了</p><p>我遇到的问题：<br> 删除不干净，导致 nvm 建立软链接失败</p></blockquote><h2 id="安装-nvm" tabindex="-1">安装 NVM <a class="header-anchor" href="#安装-nvm" aria-label="Permalink to &quot;安装 NVM&quot;">​</a></h2><p>下载地址：<a href="https://github.com/coreybutler/nvm-windows/releases" target="_blank" rel="noreferrer">https://github.com/coreybutler/nvm-windows/releases</a></p><ul><li>配置路径和下载源</li></ul><p>nvm 安装目录下<br><code>settings.txt</code> 添加如下内容</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>node_mirror: https://npm.taobao.org/mirrors/node/</span></span>
