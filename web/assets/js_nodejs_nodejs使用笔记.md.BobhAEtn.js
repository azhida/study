import{_ as s,c as n,o as a,a3 as e}from"./chunks/framework.CDwh3-Fg.js";const m=JSON.parse('{"title":"NodeJS 使用笔记","description":"","frontmatter":{},"headers":[],"relativePath":"js/nodejs/nodejs使用笔记.md","filePath":"js/nodejs/nodejs使用笔记.md","lastUpdated":1722500431000}'),p={name:"js/nodejs/nodejs使用笔记.md"},t=e(`<h1 id="nodejs-使用笔记" tabindex="-1">NodeJS 使用笔记 <a class="header-anchor" href="#nodejs-使用笔记" aria-label="Permalink to &quot;NodeJS 使用笔记&quot;">​</a></h1><h2 id="安装nodejs-—-linux" tabindex="-1">安装nodejs — linux <a class="header-anchor" href="#安装nodejs-—-linux" aria-label="Permalink to &quot;安装nodejs — linux&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>wget https://nodejs.org/dist/v14.19.2/node-v14.19.2-linux-x64.tar.xz</span></span>
